...
function PrivacyPolicySheetContent({ container }: { container?: HTMLElement | null }) {
  ...
  return (
    <SheetContent container={container} side="bottom" className="sm:max-w-2xl mx-auto mb-2 border rounded-lg h-3/4">
      <SheetHeader>
...
function ChannelListSheetContent({ 
  ...
  return (
    <SheetContent container={container} side="bottom" className="sm:max-w-2xl mx-auto mb-2 border rounded-lg h-[60vh]">
...
function AddChannelSheetContent({ onAddChannel, user, isUserLoading, container }: { onAddChannel?: (channels: M3uChannel[]) => void, user: User | null, isUserLoading: boolean, container?: HTMLElement | null }) {
  ...
  if (verifiedChannels.length > 0) {
    return (
      <SheetContent container={container} side="bottom" className="sm:max-w-2xl mx-auto mb-2 border rounded-lg h-[75vh] flex flex-col">
        <SheetHeader>
  ...
  return (
    <SheetContent container={container} side="bottom" className="sm:max-w-2xl mx-auto mb-2 border rounded-lg h-auto">
      <SheetHeader>
...
function AuthSheetContent({ container, initialTab = 'login' }: { container?: HTMLElement | null, initialTab?: 'login' | 'register' }) {
  ...
  if (isUserLoading) {
    return (
      <SheetContent container={container} side="bottom" className="sm:max-w-2xl mx-auto mb-2 border rounded-lg">
        <SheetHeader>
  ...
  if (user) {
    return (
      <SheetContent container={container} side="bottom" className="sm:max-w-2xl mx-auto mb-2 border rounded-lg h-auto overflow-y-auto">
        <SheetHeader>
