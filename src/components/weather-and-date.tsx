...
export function WeatherAndDate() {
  ...
  return (
    <div className="flex items-center gap-1.5 text-white font-medium" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.7)', fontSize: '10px' }}>
      <CloudRain size={14} className="drop-shadow-lg" />
      <span>7°</span>
      <span>|</span>
